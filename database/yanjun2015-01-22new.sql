...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-01-22 16:26:43
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `yj_employee` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='人员管理表格' AUTO_INCREMENT=12 ;

--
-- 转存表中的数据 `yj_employee`
--

INSERT INTO `yj_employee` (`id`, `did`, `pic`, `signature`, `motto`, `employee_name`, `employee_id`) VALUES
(4, 14, 'upload/20150121/142184902242.png', 'upload/20150121/142184902242.jpg', 'wrew', '1231', 3123123),
(8, 17, 'upload/20150122/142189892323.png', 'upload/20150122/142189892323.jpg', '414213412', '31241', 412412),
(9, 14, 'upload/20150122/142189897919.png', 'upload/20150122/142189897919.jpg', 'nrtr', 'hbe', 0),
(11, 16, 'upload/20150122/142191503252.png', 'upload/20150122/142191503353.gif', '王伟张伟', '王伟', 24323);
...
CREATE TABLE IF NOT EXISTS `yj_job` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='招聘信息表' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `yj_job`
--

INSERT INTO `yj_job` (`id`, `did`, `job_name`, `add_time`, `content`) VALUES
(3, 18, '财务助理', 1421914798, '财务助理工资3万3');
