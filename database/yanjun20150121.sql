...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-01-21 02:36:56
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(1, 1, 'upload/20150120/142175815919.jpg', 2),
...
CREATE TABLE IF NOT EXISTS `yj_news` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='新闻管理表格' AUTO_INCREMENT=21 ;

--
-- 转存表中的数据 `yj_news`
--

INSERT INTO `yj_news` (`id`, `title`, `content`, `images`, `date`) VALUES
(1, '对方答复', '<p>沈大高速</p>', '0', '1421561450'),
(2, '的规范健康咖啡', '<p>阿尔塔尔塔粉红哥建行卡</p>', '0', '1421561443'),
...
(20, '反光镜路弓箭手啦', '<p>的发放的萨菲</p>', 'upload/20150118/142156344303.jpg', '1421563443');
