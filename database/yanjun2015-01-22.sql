...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-01-22 03:54:43
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `yj_employee` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='人员管理表格' AUTO_INCREMENT=5 ;
...
(1, 14, 'upload/20150121/142183374404.png', 'upload/20150121/142183374404.jpg', '', '李四', 12),
(2, 14, 'upload/20150121/142184737717.png', 'upload/20150121/142184737717.jpg', '<p>王二麻子666</p>', '王二麻子', 2324),
(3, 15, 'upload/20150121/142184859535.png', 'upload/20150121/142184859535.jpg', '<p>31244142141224</p>', '3123', 321),
