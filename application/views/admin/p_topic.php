...
<!--main content start-->
    <section id="main-content">
    	<section class="wrapper">
        	<h3><i class="fa fa-angle-right"></i>投资合作伙伴</h3>
            <!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt mb">
                  <div class="col-md-12">
                      <section class="task-panel tasks-widget">
	                	<div class="panel-heading">
	                        <div class="pull-left"><h5><i class="fa fa-tasks"></i> 投资合作伙伴列表</h5></div>
                            <div class="cl"></div>
	                 	</div>
                                  ...
                                  <ul id="sortable" class="task-list">
                                  	<li>
										  <div class="task-title">
                                              ...
                                              <div class="task-title-sp pull_left" style="width:60%; overflow:hidden;text-overflow:ellipsis; white-space:nowrap; margin-left:0%; line-height:48px;">
													<b>地址</b>
                                              </div>
                                     	  </div>
                                    </li>
                                ...
                                <li <?php switch(((int)$row['id'])%4){
                                    ...
                                    <div class="task-title">
                                        ...
                                        <div class="pull-right hidden-phone" style="padding-top:20px">
                                            <button class="btn btn-primary btn-xs fa fa-pencil" onclick='location="<?php echo base_url('admin/general/p_edit?&id='.$row['id']);?>"'></button>
