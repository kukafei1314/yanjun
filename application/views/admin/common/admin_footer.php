...
<!--footer start-->
    ...
    <script type="text/javascript" src="<?php echo base_url('static/admin/assets/js/bootstrap-datepicker/js/bootstrap-datepicker.js');?>"></script>
	<script type="text/javascript" src="<?php echo base_url('static/admin/assets/js/bootstrap-daterangepicker/daterangepicker.js');?>"></script>
    <!--script for this page-->
