...
2013年，“雾霾”成为年度关键词。这一年的1月，4次雾霾过程笼罩30个省（区、市），在北京，仅有5天不是雾霾天。有报告显示，中国最大的500个城市中，只有不到1%的城市达到世界卫生组织推荐的空气质量标准，与此<p>同时，世界上污染最严重的10个城市有7个在中国。</p>
        ...
        <div class="news_right">
        	<div class="news_list">
                ...
                <a class="share"><img class="pic1" src="<?php echo base_url('static/image/pic1.png');?>" width=22 height=22/></a>
                <div class="share">
                    <a class="qq_share">
                    ...
                    <a class="weibo_share">
                        <wb:publish button_type="gray"  default_text="#<?php echo $title;?>#" default_image="http://ww1.sinaimg.cn/square/3ec33750jw1e5fksj1fdvj2028028web.jpg"></wb:publish>
                    </a>
                </div>
                <div class="cl"></div>
            </div>
